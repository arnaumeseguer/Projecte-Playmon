    ...
    return (
        <div className="flex items-center justify-center min-h-screen relative overflow-hidden bg-black text-white font-sans">
            ...
            <div className="relative z-10 w-full max-w-2xl p-8 sm:p-10 text-center">
                {/* 404 Number */}
                <div className="text-[120px] sm:text-[180px] font-black bg-gradient-to-br from-[#CC8400] via-[#E65100] to-[#CC8400] bg-clip-text text-transparent leading-none mb-4">
                    404
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <button
                        onClick={() => navigate("/")}
                        className="px-8 py-3 bg-gradient-to-r from-[#CC8400] to-[#E65100] text-black rounded-xl font-bold hover:shadow-lg hover:shadow-orange-900/40 transform hover:scale-105 transition-all duration-300"
                    >
                        Anar a l'Inici
                    </button>
                </div>
